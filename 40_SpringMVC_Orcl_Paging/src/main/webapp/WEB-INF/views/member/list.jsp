  ...
  <ul class="pagination">
	<c:if test="${pgbld.prev }">
		<li class="page-item"><a class="page-link"
		 href="/member/list?pageIdx=${pgbld.firstPageIdx-1 }&qty=${pgbld.pg.qty }"> 
	...
	<c:forEach begin="${pgbld.firstPageIdx }" end="${pgbld.lastPageIdx }" var="i">
		...
		href="/member/list?pageIdx=${i }&qty=${pgbld.pg.qty}">${i }</a></li>
	</c:forEach>
	<c:if test="${pgbld.next }">
		<li class="page-item"><a class="page-link" 
		href="/member/list?pageIdx=${pgbld.lastPageIdx+1 }&qty=${pgbld.pg.qty }"> 
