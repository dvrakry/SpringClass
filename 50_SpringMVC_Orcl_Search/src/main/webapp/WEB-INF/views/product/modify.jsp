...
<c:choose>
	<c:when
		test="${pvo.writer eq ses.email || ses.email eq 'adm@admin.com' }">
		<div class="row">
			...
			<%-- 	<input type="hidden" name="pageIdx" value="${pg.pageIdx }">
					...
					<input type="hidden" name="keyword" value="${pg.keyword }"> 이미 controller /info 에서 paging이 만들어서 존재함 그래서 여기선 또받으면 안됨 --%> 
